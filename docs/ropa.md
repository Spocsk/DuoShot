...
Date : 2026-09-12. Responsable : exploitant DuoShot (FR / CNIL). Notice interne, pas un avis d’avocat.
...
Pas d’analytics / CMP / marketing en v1. Sous-traitants : `/legal/subprocessors`. Violation : notifier la CNIL sous 72 h si risque élevé. Pas de DPO art. 37 en solo — à réévaluer.
